...
class WC_Payment_Gateway_Stripe_ACH extends WC_Payment_Gateway_Stripe {
	...
	public function get_mandate_text() {
		...
		account you select for any amount owed for charges arising from your use of %1$s 
		services and/or purchase of products from %1$s, pursuant to %1$s 
		website and terms, until this authorization is revoked. You may amend or cancel this 
		authorization at any time by providing notice to %1$s with 30 (thirty) days notice.',
