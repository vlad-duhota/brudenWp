...
use PaymentPlugins\WooCommerce\PPCP\Rest\Routes\Admin\DeactivationRoute;
...
class RestController {
	...
	public function initialize() {
		...
		$this->routes = [
			...
			'cart/order'              => new CartOrder( ...$cart_args ),
			...
			'admin/deactivate'        => new DeactivationRoute()
		];
	}

	private function get_routes() {
		return apply_filters( 'wc_ppcp_get_rest_routes', $this->routes, $this->container );
	}
