...
Tags: woocommerce, woo, wpc, fly, cart, mini-cart, floating-cart, side-cart
...
Visit our [live demo 01](https://demo.wpclever.net/woofc/?utm_source=content&utm_medium=woofc&utm_campaign=wporg "live demo 01") or [live demo 02](https://demo.wpclever.net/wpcplant/?utm_source=content&utm_medium=woofc&utm_campaign=wporg "live demo 02") to see how this plugin works.
...
= 5.1.2 =
* Added: Confirm before emptying the cart
* Added: Show saved for later products on the empty cart

= 5.1.1 =
* Added: Option to show save for later button
...
= 5.0.8 =
* Fixed: Hide on cart/checkout page while enabling Instant Checkout

= 5.0.7 =
* Fixed: Notice on settings page

= 5.0.6 =
* Fixed: Slick conflict

= 5.0.5 =
* Added: Filter hook 'woofc_above_item_inner' & 'woofc_below_item_inner'
...
= 5.0.2 =
* Fixed: Minor JS issues to compatible with WPC Smart Quick View

= 5.0.1 =
* Fixed: Minor CSS issues

= 5.0.0 =
* Added: Suggested products
...
= 4.2.9 =
* Added: Icon picker for settings page

= 4.2.8 =
* Added: Option to enable/disable confirmation before removing an item
...
= 4.2.5 =
* Fixed: Shipping cost include tax
