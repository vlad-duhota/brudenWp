...
// notice for option page
	public function update_notice_option() {
		...
		if ( $currentScreen->id == 'codeixer_page_cix-gallery-settings' ) {
			echo '<a class="cit-admin-pro-notice" href="https://www.codeixer.com/product-gallery-slider-for-woocommerce?utm_source=freemium&utm_medium=settings_page&utm_campaign=upgrade_pro" target="_blank"><p>Missing anything? Discover more powerful features in the premium version now!</p> <span>I\'m interested</span></a><script
